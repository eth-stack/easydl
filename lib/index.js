    ...
    _ensureDest() {
        return __awaiter(this, void 0, void 0, function* () {
            while (this.savedFilePath) {
                const stats = yield fs_1.fileStats(this.savedFilePath);
    ...
    _getHeaders() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this._opts.followRedirect) {
                const redirResult = yield request_1.followRedirect(this._url, this._opts.httpOptions);
                this.finalAddress = redirResult.address;
                this.headers = redirResult.headers || null;
            }
            else {
                const headerResult = yield request_1.requestHeader(this._url, this._opts.httpOptions);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (let attempt of this._attempts) {
                ...
                if (this._destroyed)
                    return;
                if (!error) {
                    yield fs_1.rename(`${this.savedFilePath}.$$${id}$PART`, `${this.savedFilePath}.$$${id}`).catch((e) => {
                        this.emit("error", e);
                    });
                ...
                yield helpers_1.delay(this._opts.retryDelay +
    ...
    _syncJobs() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < this._ranges.length; i += 1) {
                ...
                const stats = yield fs_1.fileStats(`${this.savedFilePath}.$$${i}`);
                if (!stats) {
                    this._jobs.push(i);
                    continue;
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!this.savedFilePath)
                    return;
                if (!(yield fs_1.validate(this.savedFilePath)))
